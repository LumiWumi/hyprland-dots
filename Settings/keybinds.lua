...
hl.bind(modShift .. " + P", hl.dsp.exec_cmd("uwsm app -- grim -g '$(slurp)' - | swappy -f -"))
...
hl.bind("XF86MonBrightnessUp", hl.dsp.exec_cmd("brigtnessctl -e4 -n2 set 5%+"), { locked = true, repeating = true })

hl.bind("XF86MonBrightnessDown", hl.dsp.exec_cmd("brigtnessctl -e4 -n2 set 5%-"), { locked = true, repeating = true })
